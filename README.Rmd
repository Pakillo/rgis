...
Note: this package depends on package [`velox`](https://github.com/hunzikp/velox), which has been removed from CRAN as of 2020-03-17 (see [here](https://github.com/hunzikp/velox/issues/43) for more info). While `velox` (hopefully) comes back to CRAN, installing `rgis` will install the latest `velox` version available on GitHub (0.2.0.9002). 
